...
class SeedsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create seed" do
    assert_difference('Seed.count') do
      post seeds_url, params: { seed: { acquired: @seed.acquired, name: @seed.name, source: @seed.source, sow_by: @seed.sow_by } }
    end
  ...
  test "should update seed" do
    patch seed_url(@seed), params: { seed: { acquired: @seed.acquired, name: @seed.name, source: @seed.source, sow_by: @seed.sow_by } }
